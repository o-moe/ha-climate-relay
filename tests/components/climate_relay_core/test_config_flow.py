...
class OptionsFlowTests(IsolatedAsyncioTestCase):
    ...
    async def test_custom_temperature_step_uses_default_when_payload_omits_value(
        self,
    ) -> None:
        config_entry = Mock()
        config_entry.options = {}
    ...
    async def test_custom_temperature_step_uses_default_for_none_payload_value(
        self,
    ) -> None:
        config_entry = Mock()
        config_entry.options = {}
